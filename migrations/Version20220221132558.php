 ...
 */
final class Version20220221132558 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE norma (id INT AUTO_INCREMENT NOT NULL, fecha_sancion DATE DEFAULT NULL, fecha_publicacion DATE DEFAULT NULL, titulo VARCHAR(255) NOT NULL, texto LONGTEXT NOT NULL, resumen LONGTEXT DEFAULT NULL, fecha_publicacion_boletin DATE DEFAULT NULL, estado VARCHAR(255) NOT NULL, etiquetas LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tema_norma DROP FOREIGN KEY FK_69FF1705E06FC29E');
