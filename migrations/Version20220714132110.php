 ...
 */
final class Version20220714132110 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE auditoria DROP usuario_id');
    }
