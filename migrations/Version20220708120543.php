 ...
 */
final class Version20220708120543 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE norma_usuario (norma_id INT NOT NULL, usuario_id INT NOT NULL, INDEX IDX_5BE71C49E06FC29E (norma_id), INDEX IDX_5BE71C49DB38439E (usuario_id), PRIMARY KEY(norma_id, usuario_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
