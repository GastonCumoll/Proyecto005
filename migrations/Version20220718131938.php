 ...
 */
final class Version20220718131938 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tipo_norma DROP FOREIGN KEY FK_384ABBB6BD0F409C');
        $this->addSql('DROP INDEX IDX_384ABBB6BD0F409C ON tipo_norma');
        $this->addSql('ALTER TABLE tipo_norma ADD rol VARCHAR(255) DEFAULT NULL, DROP area_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tipo_norma ADD area_id INT DEFAULT NULL, DROP rol, CHANGE nombre nombre VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE tipo_norma ADD CONSTRAINT FK_384ABBB6BD0F409C FOREIGN KEY (area_id) REFERENCES area (id)');
        $this->addSql('CREATE INDEX IDX_384ABBB6BD0F409C ON tipo_norma (area_id)');
