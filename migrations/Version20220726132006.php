 ...
 */
final class Version20220726132006 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_90B8396B4BAB96C ON tipo_norma_rol');
        $this->addSql('ALTER TABLE tipo_norma_rol ADD nombre_rol VARCHAR(255) DEFAULT NULL, DROP rol_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rol (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE tipo_norma_rol ADD rol_id INT DEFAULT NULL, DROP nombre_rol');
        $this->addSql('ALTER TABLE tipo_norma_rol ADD CONSTRAINT FK_90B8396B4BAB96C FOREIGN KEY (rol_id) REFERENCES rol (id)');
        $this->addSql('CREATE INDEX IDX_90B8396B4BAB96C ON tipo_norma_rol (rol_id)');
