 ...
 */
final class Version20220721112533 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE faltantes (id INT AUTO_INCREMENT NOT NULL, titulo VARCHAR(255) DEFAULT NULL, texto LONGTEXT DEFAULT NULL, indexdate DATETIME DEFAULT NULL, publish_start_date DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tipo_norma CHANGE nombre nombre VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE rol rol VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
