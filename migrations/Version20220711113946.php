 ...
 */
final class Version20220711113946 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE auditoria (id INT AUTO_INCREMENT NOT NULL, usuario_cargador_id INT DEFAULT NULL, usuario_modificador_id INT DEFAULT NULL, norma_id INT DEFAULT NULL, fecha_de_carga DATETIME DEFAULT NULL, fecha_de_modificacion DATETIME DEFAULT NULL, instancia_anterior INT DEFAULT NULL, instancia_actual INT DEFAULT NULL, estado_anterior VARCHAR(255) DEFAULT NULL, estado_actual VARCHAR(255) DEFAULT NULL, INDEX IDX_AF4BB49D5D340050 (usuario_cargador_id), INDEX IDX_AF4BB49D2DE240FD (usuario_modificador_id), INDEX IDX_AF4BB49DE06FC29E (norma_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE auditoria ADD CONSTRAINT FK_AF4BB49DE06FC29E FOREIGN KEY (norma_id) REFERENCES norma (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE norma_usuario (norma_id INT NOT NULL, usuario_id INT NOT NULL, fecha DATETIME DEFAULT NULL, INDEX IDX_5BE71C49E06FC29E (norma_id), INDEX IDX_5BE71C49DB38439E (usuario_id), PRIMARY KEY(norma_id, usuario_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
