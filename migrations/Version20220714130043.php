 ...
 */
final class Version20220714130043 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE auditoria ADD nombre_usuario VARCHAR(255) DEFAULT NULL');
    }
