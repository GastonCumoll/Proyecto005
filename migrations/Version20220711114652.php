 ...
 */
final class Version20220711114652 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE auditoria ADD fecha DATETIME DEFAULT NULL, DROP fecha_de_carga, DROP fecha_de_modificacion');
    }
